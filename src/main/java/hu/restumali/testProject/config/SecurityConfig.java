...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public AuthenticationSuccessHandler getAuthSuccessHandler(){ return new CustomAuthenticationSuccessHandler(); }

    @Bean
    AuthenticationFailureHandler getAuthFailureHandler(){ return new CustomAuthenticationFailureHandler(); }

    @Bean
    LogoutSuccessHandler getLogoutSuccessHandler() { return new CustomLogoutSuccessHandler(); }
